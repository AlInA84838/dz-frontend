...
function convertationMoney(moneyStart,valStart,valEnd){
const converter = 
(valStart == 'eur') && (valEnd== 'rub') ? (moneyStart * 102.14) : 
(valStart == 'rub') && (valEnd== 'eur') ? (moneyStart / 102.14) : 
(valStart == 'eur') && (valEnd== 'usd') ? (moneyStart * 1.12) : 
(valStart == 'usd') && (valEnd== 'eur') ? (moneyStart / 1.12) :
(valStart == 'rub') && (valEnd== 'usd') ? (moneyStart * 91.45) : 
(valStart == 'usd') && (valEnd== 'rub') ? (moneyStart / 91.45) : 'null';
